...
const InputModal = ({
  ...
  const generateResidentID = () => {
    const residentID =
      planetID + new Date().toLocaleTimeString() + formik.values.name;
  ...
  return (
    ...
    >
      <section className="flex flex-col justify-items-center mx-10 mb-5">
        <h1 className="text-xl font-bold text-amber-400 self-center">
          Resident Details
        </h1>
        <form onSubmit={formik.handleSubmit} className="flex flex-col w-80">
          ...
          <div className="flex items-center">
            <label
              htmlFor="name"
              className="text-sm font-bold text-amber-400 basis-1/5"
            >
              Name
            </label>
            <input
